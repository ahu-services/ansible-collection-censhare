...
- `censhare_server`: `censhare_server_version=2025.2.0`, `censhare_server_cgw_version=4.1.2-1`, `censhare_server_srs_version=4.0.1-1` (XML templates available for 2023.1 … 2026.1)
